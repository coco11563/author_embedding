...
if __name__ == '__main__':
    ...
    for i in range(600) :
        ...
        author_embedding = load_embedding(authors,
                                          '/home/xiaomeng/jupyter_base/author_embedding/codes/model/rgcn_embed_{}.pkl'.format(
                                              epoch))
        ...
        parser.add_argument("-v", "--embs", type=str, default='/home/xiaomeng/jupyter_base/author_embedding/codes/model/rgcn_embed_{}.pkl'.format(epoch),help="researcher embeddings")
